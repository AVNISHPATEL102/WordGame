...
def spaceupleftdiagonal(gr,st,r,c):
    for x in range(len(st)):
        if gr[r][c] != None:
            return False
        else:
...
def spacedownleftdiagonal(gr,st,r,c):
    for x in range(len(st)):
        if gr[r][c] != None:
            return False
        else:
...
def spaceuprightdiagonal(gr,st,r,c):
    for x in range(len(st)):
        if gr[r][c] != None:
            return False
        else:
...
def spacedownrightdiagonal(gr,st,r,c):
    for x in range(len(st)):
        if gr[r][c] != None:
            return False
        else:
    ...
    for x in range(len(wl)):
        ...
        if count==1:
            ...
            while d:
                r = random.randint(len(word), (len(gr) - 1))
                c = random.randint(len(word), (len(gr) - 1))
                if spaceupleftdiagonal(gr, word, r, c):
                    for i in range(len(word)):
                        gr[r][c] = word[i]
                        r -= 1
                        c -= 1
            ...
            while d:
                r = random.randint(0, (len(gr) - len(word)))
                c = random.randint(0, (len(gr) - len(word)))
                if spacedownleftdiagonal(gr, word, r, c):
                    for i in range(len(word)):
                        gr[r][c] = word[i]
                        r += 1
                        c += 1
            ...
            while d:
                r = random.randint(len(word), (len(gr) - 1))
                c = random.randint(0, (len(gr) - len(word)))
                if spaceuprightdiagonal(gr, word, r, c):
                    for i in range(len(word)):
                        gr[r][c] = word[i]
                        r -= 1
                        c += 1
            ...
            while d:
                r = random.randint(0, (len(gr) - len(word)))
                c = random.randint(len(word), (len(gr) - 1))
                if spacedownrightdiagonal(gr, word, r, c):
                    for i in range(len(word)):
                        gr[r][c] = word[i]
                        r += 1
                        c -= 1
